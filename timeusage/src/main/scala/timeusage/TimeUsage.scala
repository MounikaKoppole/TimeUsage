...
object TimeUsage {
  ...
  */
  ...
  /** @return An RDD Row compatible with the schema produced by `dfSchema`
    ...
    */
  def row(line: List[String]): Row = ???  // { YOUR CODE HERE }
  ...
  def timeUsageSummary( primaryNeedsColumns : List[Column]
    ...
    val workingStatusProjection: Column = ??? // { YOUR CODE HERE }

    val sexProjection: Column = ??? // { YOUR CODE HERE }

    val ageProjection: Column = ??? // { YOUR CODE HERE }
    ...
    val primaryNeedsProjection: Column = ??? // { YOUR CODE HERE }
      
    val workProjection: Column = ??? // { YOUR CODE HERE }
      
    val otherProjection: Column = ??? // { YOUR CODE HERE }
  ...
  /** @return the average daily time (in hours) spent in primary needs, working or leisure, grouped by the different
    ...
    */
  def timeUsageGrouped(summed: DataFrame): DataFrame = ??? // { YOUR CODE HERE }
